...
Route::get('/admin/gallery/{paging?}',                         ['middleware' => 'auth', 'uses' => 'Admin\AdminController@showGallery']);
Route::get('/admin/gallery/edit/{itemid}',           ['middleware' => 'auth', 'uses' => 'Admin\AdminController@showEditGalleryItem']);
Route::get('/admin/banner/{paging?}',                       ['middleware' => 'auth', 'uses' => 'Admin\AdminController@showBanner']);
Route::get('/admin/ads/{paging?}',                       ['middleware' => 'auth', 'uses' => 'Admin\AdminController@showAds']);
