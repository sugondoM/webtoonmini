...
<form action="{{url('admin/ads/doedit')}}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{ method_field('put')}}
    ...
    <div id="page-upload-right" class="thumb-big">
        <div id="page-smale-container">
            ...
            <input type="text" value="{{old('ads_name',$item->ads_name)}}" placeholder="Less Than 50 Character" name="ads_name" class="custom-inputtext width-500"/>
