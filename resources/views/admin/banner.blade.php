  ...
  @if($page['total_paging']>1)
    	 ...
    	 <div class="theme-bg-color-1">
    	 	<div class="page-paging-container theme-bg-color-1 theme-paging">
    			...
    			@endphp
    			@if($page_prev > 0)
    			<a href="/admin/banner/{{$page_prev}}" class="prev">
    			<div >
    				< prev
    			</div>
    			</a>
    			...
    			@for($i=0;$i<$page['iteration'];$i++)
    				<a href="/admin/banner/{{$page['start_paging']+$i}}" @if($page['start_paging']+$i == $page['current_paging']) class="active" @endif>
    			...
    			<a href="/admin/banner/{{$page_next}}" class="next">
    			<div>
    				next >
    			</div>
    			</a>
