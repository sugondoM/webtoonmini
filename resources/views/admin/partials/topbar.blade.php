<div id="main-topbar-container">
    ...
    <div class="header no-shadow">
        ...
        <a href = "{{url('/admin/series/list')}}" class="menu-button @if(Request::is('admin/series')||Request::is('admin/series/*')||Request::is('admin/episode/*')) active @endif"> 
        	Series
        </a>
        <a href = "{{url('/admin/gallery/add')}}" class="menu-button  @if(Request::is('admin/gallery/*')) active @endif">
        	Gallery
        </a>
    ...
    @if(Request::is('admin/series')||Request::is('admin/series/*')||Request::is('admin/episode/*'))
