...
<form action="{{url('/uploadseries')}}" method="post" enctype="multipart/form-data">
    ...
    <div id="page-upload-left">
        <div id="page-smile-container">
            ...
            <div class="thumbnail-image-container">
                <p></p>
                <img class="thumbnail-image-priview" id="thumbnail-image" src="/{{$series->thumbnail_url}}" height="200" width="200">
            </div>
    ...
    <div id="page-upload-right">
        <div id="page-smale-container">
            ...
            <input type="text" value="{{$series->series_title}}" placeholder="Less Than 50 Character" name="series_title" class="custom-inputtext width-500"/>
